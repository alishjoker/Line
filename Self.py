...
admin=["uf2c43dc343ada06bd251c97c7b5c6487","u225b5713800eb4c9841f289257bfd598"]
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"http://line.me/ti/p/~joker.alish")
						print "DiLike"
					except:
							pass
				else:
