...
Bots=[mid,Amid]
admin=["uf2c43dc343ada06bd251c97c7b5c6487"]
creator=["uf2c43dc343ada06bd251c97c7b5c6487"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Admin Bot line.me/ti/p/joker.alish",
    "lang":"JP",
    "comment":"Admin Bot line.me/ti/p/joker.alish",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
    ...
    try:
        ...
        if op.type == 15:
            if op.param2 in Bots:
                return
            ki.sendText(op.param1, "Good Bye ͡° ͜ʖ ͡°")
            print "MemberLeft"
        if op.type == 13:
            if op.param3 in mid:
...
#-----------------------------------------------
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "uf2c43dc343ada06bd251c97c7b5c6487"}
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By line.me/ti/p/~Joker.alish")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"BOT NAME : ALISH JOKER ☺😍")
						print "DiLike"
					except:
							pass
				else:
